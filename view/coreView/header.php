    ...
    <nav class="navbar navbar-expand-lg navbar-light">
      ...
      <div class="collapse navbar-collapse" id="navbarColor01" style="margin-left: 4rem;">
        <ul class="navbar-nav mr-auto my-lg-0 ">
          ...
          <?php if (isset($_SESSION['id_restaurant'])) { ?>
            ...
            <?php } ?>
            <li class="nav-item">
              <a class="nav-link" style="color: rgb(127, 255, 8);" href="index.php?page=restaurantCompte">
                <?php echo ucfirst($_SESSION['pseudo']); ?>
              </a>
            </li>

            <li class="nav-item">
              <a class="nav-link" style="color: rgb(127, 255, 8);" href="#">menu</a>
            </li>
          ...
          <?php } else { ?>
            <li class="nav-item">
              <a class="nav-link" style="color: rgb(127, 255, 8);" href="index.php?page=inscriptionRestaurant">Restaurant</a>
            </li>
            <li class="nav-item">
